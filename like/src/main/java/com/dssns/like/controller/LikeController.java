...
public class LikeController {
  ...
  public ApiResponse<Void> likePost(@PathVariable("postNo") Long postNo, @RequestParam Long userNo,
      @RequestParam Long postCreatorUserId, HttpServletRequest httpServletRequest) {
  ...
  public ApiResponse<Void> likeCancelComment(@PathVariable("commentNo") Long commentNo,
      @RequestParam Long userNo) {
