...
(
    ...
    `last_modified_by` BIGINT UNSIGNED NULL COMMENT '수정자 ID',
    `del_yn`           VARCHAR(2)      NOT NULL DEFAULT 'N' COMMENT '삭제 여부 (Y/N)',

    CONSTRAINT `pk_user` PRIMARY KEY (`id`)
--   CONSTRAINT `uk_user_email` UNIQUE (`email`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='사용자 정보';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='습관 정보';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='습관 기록';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='구독 정보';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='상품 정보';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='주문 정보';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='주문 상품 정보';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='주문 결제 정보';
