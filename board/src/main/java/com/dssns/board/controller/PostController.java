...
public class PostController {
  ...
  public ApiResponse<AddPostResponseDto> addPost(
      @RequestBody @Valid AddPostRequestDto addPostRequestDto) {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ApiResponse<AddCommentResponseDto> addComment(@PathVariable("postNo") Long postNo,
      @Valid @RequestBody
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ApiResponse<GetPostCommentsResponseDto> getPostComments(
